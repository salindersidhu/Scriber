# Contributing to Scriber

Scriber is an open source community project, and everyone is welcome to contribute. This short guide will assist you with the workflow required in successfully having your features and bug fixes merged into the project.
...
### Creating a Fork
The best approach to contribute code to Scriber is to fork the [main repository](https://github.com/salindersidhu/scriber) on GitHub, then submit a pull request.
...
```bash
git clone https://github.com/USERNAME/scriber.git

# If you have an SSH key setup with GitHub
git clone git@github.com:USERNAME/scriber.git
...
git remote add upstream https://github.com/salindersidhu/scriber.git
```
...
If you find a bug in the code, please submit a ticket to the [Bug Tracker](https://github.com/salindersidhu/scriber/issues).
...
- The version of Scriber you are using.